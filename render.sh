...
# add the GoogleTextToSpeech plugin
python3 -c "import requests; r=requests.get('https://github.com/nelson9608/simplebot-scripts/raw/master/scripts/GoogleTextToSpeech.py'); open('GoogleTextToSpeech.py', 'wb').write(r.content)"
python3 -m simplebot -a "$ADDR" plugin --add ./GoogleTextToSpeech.py
